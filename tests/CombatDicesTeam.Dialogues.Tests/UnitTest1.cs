...
public class HideConditionsTests
{
    ...
    public void Test1()
    {
        ...
        var dialogue = new Dialogue<object, object>(new DialogueNode<object, object>(new DialogueParagraph<object, object>(ArraySegment<DialogueSpeech<object, object>>.Empty), new []
        {
    ...
    public void Test2()
    {
        ...
        var factory = Mock.Of<IDialogueContextFactory<object, object>>();
        var dialogueOption = new DialogueOption<object, object>("1", new DialogueNode<object, object>(new DialogueParagraph<object, object>(ArraySegment<DialogueSpeech<object, object>>.Empty), new[]
        {
            new DialogueOption<object, object>("2", DialogueNode<object, object>.EndNode)
            {
                HideConditions = new []
